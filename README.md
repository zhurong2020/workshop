...
> **当前主站**: [arong.eu.org](https://www.arong.eu.org) (WordPress，托管于 VPS)
> **管理方式**: 通过 Remote SSH 登录 VPS 进行 WordPress 操作
> **相关项目**: [vpsserver](https://github.com/zhurong2020/vpsserver) - VPS 服务器配置和 WordPress 后端管理

**博客平台演进历程：**
1. **Gridea 静态博客** → [zhurong2020.github.io](https://zhurong2020.github.io) (86篇历史文章存档)
2. **Jekyll + GitHub Pages** → 本项目 workshop (创作工具和发布系统)
3. **WordPress** → [arong.eu.org](https://www.arong.eu.org) (当前主站，所有新内容发布于此)

本项目 (workshop) 作为内容创作和多平台发布的工具链继续维护，支持向 WordPress 主站的自动发布。
