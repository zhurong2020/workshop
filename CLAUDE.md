...
- **新博客(Jekyll)本地路径**: `/home/wuxia/projects/personal/websites/workshop/_posts/`
  - 当前已发布30篇文章
  - 其中11篇为从Gridea迁移过来的文章
- **WordPress博客**: https://www.arong.eu.org
  - VPS服务器: `arong-vps` (SSH别名)
  - 网站根目录: `/var/www/arong.eu.org/public_html/`
  - 当前文章数: **99篇** (2025-12-31三网合一完成)
  - 迁移工具: `scripts/tools/wordpress_migration/`
  - 迁移状态: ✅ 三网合一完成 - Gridea 80篇 + Jekyll公开文章已全部迁移
  - 7大分类: 云技术入门(32)、投资理财(24)、认知升级(21)、全球视野(10)、开源应用(5)、论文周报(5)、英语学习(2)
...
- **企业微信群**:
  - 群名称: 有心同行
  - 定位: 免费交流社群（同好互助，非服务承诺）
  - 群活码: `/home/wuxia/projects/vpsserver/configs/wecom/assets/contact_me_qr.png`
